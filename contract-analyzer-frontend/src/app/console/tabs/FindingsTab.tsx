...
export function FindingsTab() {
  ...
  const setFindingsFilter = useStore((s) => s.setFindingsFilter);
  const clearFindingsFilter = useStore((s) => s.clearFindingsFilter);
      ...
      <div className="space-y-2">
            ...
            return (
              <button
                ...
                onClick={() => {
                  ...
                  setFindingsFilter({ riskLevels: next });
                }}
              >
                {level}
              </button>
        ...
        <div className="flex items-center gap-2">
          <select
            ...
            onChange={(e) => setFindingsFilter({ category: e.target.value })}
          >
          ...
          <select
            ...
            onChange={(e) => setFindingsFilter({ standard: e.target.value })}
          >
                    ...
                    <div className="mt-2 flex items-center gap-3">
                      ...
                      {clause && (
                        <button
                          ...
                          onClick={() =>
                            selectClause(finding.clause_id)
                          }
                        >
                          &sect;{clause.clause_number || clause.title}
                        </button>
                      )}
                    </div>
                  </div>
